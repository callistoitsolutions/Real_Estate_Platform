...
################ Views start for buyer subscriptions #####################

def Subscriptions_Buyer(request):
    ...
    return render(request, "buyer_panel/Subscription/subscription.html", context)


############### Views end for buyer subscriptions #########################


############## Views start for buy plan for buyer ########################

def Buy_Plan_Buyer(request,id):
    ...
    return render(request, "buyer_panel/Subscription/buy_package.html", context)


############## Views end for buy plan for buyer ##############################
