...
############# Views start for rental edit forms for landlord #####################
...
def residential_landlord_edit(request, pk):
    ...
    # 2.  VIP Access Control
    is_valid_agency = (user_id and logged_in_role == "Landlord")
    is_valid_admin = (admin_id and logged_in_role == "Admin" and 'impersonate_id' in request.session)
    ...
    return render(request, 'landlord/Forms/Rental/residential_edit.html', {
        'property': prop,
        'user_obj': user_obj,
...
############ Views start for view rental forms for landlord #######################
...
def residential_landlord_view(request, pk):
    ...
    # 2.  VIP Access Control
    is_valid_agent = (user_id and logged_in_role == "Landlord")
    is_valid_admin = (admin_id and logged_in_role == "Admin" and 'impersonate_id' in request.session)
    ...
    return render(request,
        'landlord/Forms/Rental/residential_view.html',
        context)
