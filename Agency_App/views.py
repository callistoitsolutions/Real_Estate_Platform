...
def residential_resale_agency_view(request,id):
    ...
    # 2. VIP Access Control
    is_valid_landlord = (user_id and logged_in_role == "Agency/Builder")
    is_valid_admin = (admin_id and logged_in_role == "Admin" and 'impersonate_id' in request.session)
...
########### Views start for update resale residential form ###############

def residential_resale_agency_update(request,id):
    ...
    return render(request, "agency_panel/Forms/Resale/residential_resale_edit.html", context)


############# Views end for update resale residential form ####################
...
############# Views start for commercial resale property form #######################

def commercial_resale_agency_update(request,id):
    ...
    return render(request,'agency_panel/Forms/Resale/commercial_resale_edit.html',context)


############## Views end for commercial resale property form #####################


########### Views start for view commercial resale property form #################

def commercial_resale_agency_view(request,id):
    ...
    is_valid_rm = (session_user_id and logged_in_role == "Agency/Builder")
    ...
    return render(request, 'agency_panel/Forms/Resale/commercial_resale_view.html', context)


############# Views end for view commercial resale property form ####################
...
########## Views start for update industry resale property form ##############

def industrial_resale_agency_update(request,id):
    ...
    return render(request, 'agency_panel/Forms/Resale/industrial_edit.html', context)


############# Views end for update industry resale property form #################


########## Views start for view resale industry property form ######################

def industrial_resale_agency_view(request,id):
    ...
    return render(request, 'agency_panel/Forms/Resale/industrial_view.html', context)


########## Views end for view resale industrial property form #####################
...
def agricultural_resale_agency_update(request,id):
    ...
    return render(request, 'agency_panel/Forms/Resale/edit_agricultural_resale.html', context)
...
def agricultural_resale_agency_view(request,id):
# 1. Retrieve identity from browser session
    session_user_id = request.session.get('User_id')
    logged_in_role = request.session.get('user_type')
    ...
    return render(request, 'agency_panel/Forms/Resale/view_agriculture_resale.html', context)
...
def residential_plot_resale_agency(request):
   # 1. Retrieve BOTH possible session IDs from the browser
    ...
    return render(request, "agency_panel/Forms/Resale/Plots/res_plots.html", context)
...
def residential_plot_resale_list_agency(request):
    ...
    return render(request, 'agency_panel/Reports/Resale/Plots/res_plots_list.html', context)


############# Views start for update plot resale residential form #################

def residential_plot_resale_agency_update(request,id):
# 1. Retrieve identity from browser session
    session_user_id = request.session.get('User_id')
    logged_in_role = request.session.get('user_type')
    ...
    return render(request,"agency_panel/Forms/Resale/Plots/update_resi_plots.html",context)


############ Views end for update plot resale residential form ####################

############## Views start for view resale residential plot form ################

def residential_plot_resale_agency_view(request,id):
    ...
    return render(request,"agency_panel/Forms/Resale/Plots/view_resi_plots.html",context)


############## Views end for view resale residential plot form ####################
...
def commercial_plot_resale_agency(request):
    ...
    return render(request, "agency_panel/Forms/Resale/Plots/comm_plots.html", context)
...
def commercial_plot_resale_list_agency(request):
    ...
    return render(request, 'agency_panel/Reports/Resale/Plots/comm_plots_list.html', context)


############ Views start for update plot resale commercial form ####################

def commercial_plot_resale_agency_update(request,id):
    ...
    return render(request,"agency_panel/Forms/Resale/Plots/update_comm_plots.html",context)


############ Views end for update plot resale commercial form ######################


############# Views start for view plot resale commercial form ####################

def commercial_plot_resale_agency_view(request,id):
    ...
    return render(request,"agency_panel/Forms/Resale/Plots/view_comm_plots.html",context)


############# Views end for view plot resale commercial form ###################
...
def residential_add_agency(request):
    # 1. Retrieve identity from browser session
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
 ...
 # ---------- AMENITIES & FACILITIES ----------
    ...
    return render(request, 'agency_panel/Forms/Rental/residential.html', {
        'user_obj': user_obj,
        'user_role': user_role,
...
def residential_agency_view(request, pk):
    ...
    return render(request, 'agency_panel/Forms/Rental/residential_view.html', context)
...
def residential_agency_edit(request, pk):
    ...
    return render(request, 'agency_panel/Forms/Rental/residential_edit.html', context)
...
@require_POST
def rental_residential_delete_agency(request, pk):
    """Agency/Builder Soft Delete Property (supports Admin impersonation)"""
    ...
    try:
        ...
        try:
            ...
            return JsonResponse({
                'status': 'error',
                'message': 'Agency/Builder not found.'
            })

        # Build identity string — note if this was an admin acting on the agency's behalf
        if is_valid_admin:
            admin_obj = Admin_Login.objects.filter(id=admin_id).first()
            ...
            user_role = "Admin (Impersonating Agency/Builder)"
        else:
            user_identity = (
            ...
            user_role = user_obj.user_role or "Agency/Builder"
        ...
        # ======================================
        # 6. Security Check — agency can delete only own property
        # ======================================
...
@require_POST
def rental_bulk_delete_agency(request):
    """Agency/Builder Advanced Bulk Delete (Soft Delete) — scoped to agency's own properties, supports Admin impersonation."""
    ...
    try:
        ...
        try:
            ...
            return JsonResponse({'status': 'error', 'message': 'Agency/Builder not found.'})
        ...
        # ======================================
        # 6. Base Queryset — SCOPED TO THIS AGENCY/BUILDER ONLY
        # ======================================
...
############# Views end for rental forms for Agency ###########################




########### Views start for commercial rental Listing  for Agency #######################
...
def commercial_rental_add_agency(request):
    ...
    return render(request, 'agency_panel/Forms/Rental/commercial.html'
   , {
        'user_obj': user_obj,
...
def commercial_agency_edit(request, pk):
    ...
    return render(request, 'agency_panel/Forms/Rental/commercial_edit.html', context)
...
def commercial_view_agency(request, pk):
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
    ...
    return render(request, 'agency_panel/Reports/Rental/commercial_detail.html', {
...
def commercial_list_agency(request):
    ...
    return render(request, 'agency_panel/Reports/Rental/commercial_list.html', context)
...
def export_commercial_rent_agency(request):
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
...
@require_POST
def commercial_delete_agency(request, pk):
    """Agency/Builder Soft Delete Commercial Property (supports Admin impersonation)"""
    ...
    try:
        ...
        if is_valid_admin:
            ...
            user_identity = (
                f"[Impersonated] Acting Admin: {admin_label} | "
                f"On behalf of User ID: {agency_obj.user_id} | "
                f"Name: {agency_obj.user_name} | "
                f"Email: {agency_obj.user_email} | "
                f"Phone: {agency_obj.user_phone} | "
                f"Role: {agency_obj.user_role}"
            )
            user_role = "Admin (Impersonating Agency/Builder)"
        else:
            user_identity = (
                f"User ID: {agency_obj.user_id} | "
                f"Name: {agency_obj.user_name} | "
                f"Email: {agency_obj.user_email} | "
                f"Phone: {agency_obj.user_phone} | "
                f"Role: {agency_obj.user_role}"
            )
            user_role = agency_obj.user_role or "Agency/Builder"
        ...
        # 6. Security Check — agency can delete only own property
        # ======================================
        if str(prop.listed_by_id) != str(agency_obj.user_id):
            return JsonResponse({
                'status': 'error',
                'message': 'You can delete only your own properties.'
            })
...
@require_POST
def commercial_bulk_delete_agency(request):
    """Agency/Builder Advanced Bulk Delete (Soft Delete) — scoped to agency's own commercial properties, supports Admin impersonation."""
    ...
    try:
        ...
        properties = CommercialRentalProperty.objects.filter(
            is_deleted=False,
            listed_by_id=agency_obj.user_id
        )
...
############# Views start for Rental pg Module for Agency ###################################################
...
def pg_list_agency(request):
    ...
    return render(request, 'agency_panel/Reports/Rental/pg_list.html', {
...
def add_pg_agency(request):
    ...
    try:
        ...
        uploader_role = getattr(user_obj, 'user_role', 'User') if user_obj else 'Agency/Builder'
        uploader_id = f"USER_{user_id}"
...
def pg_agency_edit(request, pk):
    ...
    if request.method == "GET":
        ...
        return render(request, 'agency_panel/Forms/Rental/pg_edit.html', context)
    ...
    try:
        ...
        return JsonResponse({
            ...
            "redirect_url": reverse('pg_list_agency')
        })
...
def export_pg_coliving_agency(request):
...
def pg_coliving_view_agency(request, pk):
    ...
    return render(request, "agency_panel/Reports/Rental/pg_coliving_view.html", context)



@require_POST
def pg_coliving_delete_agency(request, pk):
    """Agency/Builder Soft Delete PG/Coliving Property (supports Admin impersonation)"""
    ...
    try:
        ...
        # 6. Security Check — agency can delete only own property
        # ======================================
        if str(pg.listed_by_id) != str(agency_obj.user_id):
            return JsonResponse({
                'status': 'error',
                'message': 'You can delete only your own properties.'
            })
...
############# Views start for subscription for boost property for agency ##############

def Boost_Property_Agency(request):
    # 1. Retrieve BOTH possible session IDs from the browser
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
    ...
    return render(request, "agency_panel/Boost_Property/boost_property.html", context)

############ Views end for subscription for boost property for agency #################


############ Views start for buy plan for agency/builder #######################

def Buy_Plan_Agency(request,id):
    ...
    return render(request, "agency_panel/Boost_Property/buy_package.html", context)


########### Views end for buy plan for agency/builder #############################

@require_POST
def pg_bulk_delete_agency(request):
    """Agency/Builder Advanced Bulk Delete (Soft Delete) — scoped to agency's own PG/Coliving properties, supports Admin impersonation."""
    ...
    try:
        ...
        try:
            ...
            return JsonResponse({'status': 'error', 'message': 'Agency/Builder not found.'}, status=404)
...
############# Views END for Rental pg Module for Agency ###################################################



############# Views Start for Resale Plot Industrial Module for Agency ######################################
...
def industrial_plot_resale_add_agency(request):
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/industrial_plot_resale_list.html', {
...
def industrial_plot_resale_edit_agency(request, pk):
    ...
    "redirect_url": reverse('industrial_plot_resale_list_agency')
})
        except Exception as e:
            print("ERROR DETECTED:", str(e))
            return JsonResponse({
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/industrial_plot_resale_edit.html', {
...
def industrial_plot_resale_view_agency(request, pk):
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/industrial_plot_resale_view.html', {
        'user_obj': user_obj,
...
@require_POST
def industrial_plot_resale_delete_agency(request, pk):
    """Agency/Builder Soft Delete Industrial Plot Resale Property (supports Admin impersonation)"""
    ...
    try:
        ...
        # 6. Security Check — agency can delete only own property
        # ======================================
        if str(plot.listed_by_id) != str(agency_obj.user_id):
            return JsonResponse({
                'status': 'error',
                'message': 'You can delete only your own properties.'
            })
        ...
        IndustrialPlotResaleActivityLog.objects.create(
            ...
            action_type="DELETE",
            property_id=plot.id,
            action_payload=json.dumps({"reason": "Manual delete via Agency/Builder list page"}),
            status="SUCCESS",
        )
...
@require_POST
def industrial_plot_resale_bulk_delete_agency(request):
    """Agency/Builder Advanced Bulk Delete (Soft Delete) — scoped to agency's own industrial plots, supports Admin impersonation."""
    ...
    try:
        ...
        if delete_type == "current_page":
            ...
            pass  # qs already scoped to this agency's non-deleted rows
...
def export_industrial_plot_resale_agency(request):
...
############# Views End for Resale Plot Industrial Module for Agency ######################################




############# Views Start for Resale Plot Agriculture Module for Agency ######################################
...
def agricultural_plot_resale_add_agency(request):
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/agricultural_plot_resale_list.html', {
...
def agricultural_plot_resale_edit_agency(request, pk):
    user_id = request.session.get('User_id')
    admin_id = request.session.get('Admin_id') 
    logged_in_role = request.session.get('user_type')
    ...
    if request.method == 'POST':
        try:
            ...
            return JsonResponse({
                ...
                'redirect_url': reverse('agricultural_plot_resale_list_agency')
            })
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/agricultural_plot_resale_edit.html', {
...
def export_agricultural_plot_resale_agency(request):
...
def agricultural_plot_resale_view_agency(request, pk):
    ...
    return render(request, 'agency_panel/Reports/Resale_Plot/agricultural_plot_resale_view.html', {
        'user_obj': user_obj,
...
@require_POST
def agricultural_plot_resale_delete_agency(request, pk):
    """Agency/Builder Soft Delete Agricultural Plot Resale Property (supports Admin impersonation)"""
...
@require_POST
def agricultural_plot_resale_bulk_delete_agency(request):
    """Agency/Builder Advanced Bulk Delete (Soft Delete) — scoped to agency's own agricultural plots, supports Admin impersonation."""
